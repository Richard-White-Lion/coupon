...
class CMB_Gmap_Field extends CMB_Field {
	...
	public function enqueue_scripts() {
		...
		$api = '';
		if( function_exists('travelog_get_option') ){
			$google_api_key = travelog_get_option( 'google_api_key' );
			if( !empty( $google_api_key ) ){
				$api = '&key='.$google_api_key;
			}
		}

		wp_enqueue_script( 'cmb-google-maps', '//maps.google.com/maps/api/js?libraries=places&sensor=false'.$api );
